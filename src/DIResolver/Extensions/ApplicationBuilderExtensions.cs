...
namespace BoldDesk.Search.DIResolver.Extensions
{
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        public static IApplicationBuilder BuildApplication(this IApplicationBuilder app, IWebHostEnvironment environment)
        {
            ...
            var corsValue = app.ApplicationServices.GetRequiredService<IOptions<CORSPolicy>>().Value;
            ...
            app.UseApplicationInsightsTelemetry(environment); // Application insights
